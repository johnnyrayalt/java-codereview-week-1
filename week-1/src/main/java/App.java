    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if(userInputNumberOfGuests > 0) {
                ...
                event.setFoodSelection(stringUserInputFoodOption);

                if (event.getFoodItemsAndPrices().equals(stringUserInputFoodOption)) {
                    ...
                    if (event.getBeverageItemsAndPrices().equals(stringUserInputBeverageOption)) {
                        ...
                        if (event.getEntertainmentOprionsAndPrices().equals(stringUserInputEntertainmentOption)) {
